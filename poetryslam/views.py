...
class inversereg(View):
	...
	def post(self, request, *args, **kwargs):
		...
		if form.is_valid():
			...
			obj = InverseParticipant(name=name, place=place, occupation=occupation, preferredCity=preferredCity, email= email, phone_number=phone_number, prior_experience_if_any=prior_experience_if_any)
